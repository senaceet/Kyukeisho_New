...
<%@page import="modelo.Productos_no_tan_vendidos_DAO"%>
...
<head>
    ...
    <title>CRUD Productos poco vendidos</title>
    ...
    <style type="text/css">
        ...
        <table class="table table-striped table-hover "  width="1000">
            ...
            <tr bgcolor="#C0BB2E">
                        ...
                        <%
                    Productos_no_tan_vendidos_DAO dao=new Productos_no_tan_vendidos_DAO();
                ...
                %>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="controlador_productos_no_tan_vendidos?accion=editar&id_producto=<%= ma.getid_producto() %>" class="edit"><i
                                            style="color:rgb(245, 221, 9)" class="material-icons" data-toggle="tooltip" title="Editar" value="">&#xE254;</i></a>
                                            
                                    <a href="controlador_productos_no_tan_vendidos?accion=elimi&id_producto=<%= ma.getid_producto() %>" class="delete"><i
            ...
            <div id="addcate" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form action="controlador_productos_no_tan_vendidos">
            ...
            <div id="editcate" class="modal fade">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <%
              Productos_no_tan_vendidos_DAO dao2=new Productos_no_tan_vendidos_DAO();
          ...
          %>
            ...
            <div id="elimicate" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <%
              Productos_no_tan_vendidos_DAO dao3=new Productos_no_tan_vendidos_DAO();
