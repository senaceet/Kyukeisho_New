    ...
    <script type="text/javascript">
        $(document).ready(function () {
         ...
         <center>
             <div class="container" >
                 <div class="row" >
                     <table class="table table-striped table-hover text-center "  width="5000" align="center">
                         <thead>
                         <tr bgcolor="#088A68">
                             <th align="center" colspan="9"><h2 style="text-align:left" text="left">Usuarios</h2>
                         <th align="right" colspan="9" style="text-align:right">                 
                            <a  href="eliminar_usuario" class="btn btn-danger" data-toggle="modal"><i
                                    class="material-icons"><i class="fa fa-trash" aria-hidden="true"></i>
                                </i><span>Eliminar Usuario</span></a>
                         </th>
                         <th align="right" colspan="9">  
                             <a href="insertarcliente.jsp" class="btn btn-success" >
                                 <i class="fa fa-plus-circle" aria-hidden="true"></i>
                                </i><span>Registrar Nuevo Usuario</span></a>
                         </th>
                     </th>
            </tr>
        ...
        <table class="table table-striped table-hover text-center "  width="1000">
            ...
            <tr bgcolor="#04B486">
                ...
                <th  colspan="2">Id Usuario</th><th colspan="2">Primer Nombre</th>
                <th colspan="2">Segundo Nombre</th><th colspan="2">Primer Apellido</th>
                <th colspan="2">Segundo Apellido</th><th colspan="2">Correo Usuario</th>
                <th colspan="2">Telefono Usuario</th><th colspan="2">Dirección</th>
                <th colspan="2">Contraseña Usuario</th>
            ...
            rs = sta.executeQuery("select * from usuario ORDER BY id_usuario asc limit 50");
            ...
            %>
                <tr>
                    ...
                    <th colspan="2" style="text-align:left"> <%=rs.getString(2)%></th>
                    <th colspan="2"><%=rs.getString(3)%></th>
                    <th colspan="2"><%=rs.getString(4)%></th>
                     <th colspan="2"><%=rs.getString(5)%></th>
                      <th colspan="2"><%=rs.getString(6)%></th>
                       <th colspan="2"><%=rs.getString(7)%></th>
                        <th colspan="2"><%=rs.getString(8)%></th>
                         <th colspan="2"><%=rs.getString(9)%></th>
                    <th colspan="2">
                        <a href="editar_usuario.jsp?cod=<%=rs.getString(1)%>">
                            <i class="fa fa-pencil" aria-hidden="true"</i>
                        </a>
                    </th>
                    
                    <th colspan="2">
                        <a href="eliminar_usuario?cod=<%=rs.getString(1)%>">
