...
String listar="/persona.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(action.equalsIgnoreCase("listar")){
            ...
            CJ.setdocumento_persona(Integer.parseInt(request.getParameter("documento_persona")));
            ...
            CJ.setcodigo_ciudad(Integer.parseInt(request.getParameter("codigo")));
            dao.add(CJ);
            acceso=listar;
        }
            ...
            CJ.setdocumento_persona(Integer.parseInt(request.getParameter("documento_persona2")));
            ...
            CJ.setcodigo_ciudad(Integer.parseInt(request.getParameter("codigo2")));
