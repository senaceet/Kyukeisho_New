...
<html>
    ...
    <body>
        <!-- Creamos la parte superior de la página -->
       <style type="text/css">
                body{
                  background: #eeeeee;
                }
    ...
    <!-- Creamos los contenedires vacios -->                  
       </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                ...
                <hr>            
    <!-- Creamos las filas que llevan la accion a realizar -->       
                 <div class="row">
                        <div class="col-lg-4">
                            <center>
                                <form action="persona.jsp" method="post">
                                <input type="submit" value="Persona">
                                <br><br>
                                <img src="https://image.freepik.com/vector-gratis/perfil-avatar-mujer-icono-redondo_24640-14047.jpg" width="70">
                              </form>
                            </center>    
                </div>
                <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                            <center>
                                ...
                                <input type="submit" value="Ciudad">
                                <br><br>
                                <img src="https://vignette.wikia.nocookie.net/avatar/images/6/65/Tribu_agua_del_norte_actual.png/revision/latest?cb=20140603154653&path-prefix=es" width="70">
                              </form>
                            </center>
                </div>    
