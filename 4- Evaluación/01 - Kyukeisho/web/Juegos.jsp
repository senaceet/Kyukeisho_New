...
<body>
    ...
    <style type="text/css">
        ...
        <table class="table table-striped table-hover "  width="1000">
          ...
          %>
                        <form action="controlador_juegos">
                            ...
                            <div class="modal-body">
                             ...
                             <input type="hidden" class="form-control" required value="<%= ma2.getcodigo_juego() %>" name="codigo2">
          ...
          %>
                        <form action="controlador_juego">
                            <div class="modal-header" style="background-color: rgb(216, 211, 40)">
                                <h4 class="modal-title">Eliminar Juego</h4>
                                <button type="button" class="close" data-dismiss="modal"
                                    aria-hidden="true">&times;</button>
                            </div>
                          <input type="hidden" class="form-control" required value="<%= ma3.getcodigo_juego() %>" name="codigo3">
