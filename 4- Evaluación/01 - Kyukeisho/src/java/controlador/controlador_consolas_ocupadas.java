...
import modelo.consolas_ocupadas_DAO;
...
@WebServlet(name = "controlador_consolas_ocupadas", urlPatterns = {"/controlador_consolas_ocupadas"})
public class controlador_consolas_ocupadas extends HttpServlet {
String listar="/CRUD_Consolas_ocupadas.jsp";

    consolas_ocupadas PV = new consolas_ocupadas();
