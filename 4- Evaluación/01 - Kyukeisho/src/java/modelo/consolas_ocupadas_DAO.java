...
import java_interfaces.CRUD_consolas_ocupadas;


public class consolas_ocupadas_DAO implements CRUD_consolas_ocupadas {
    ...
    consolas_ocupadas CJ =new consolas_ocupadas();

    @Override
    public List listar() {
        ArrayList<consolas_ocupadas>list=new ArrayList<>();
        ...
        try {
            ...
            rs=ps.executeQuery();
            while(rs.next()){
                consolas_ocupadas ma=new consolas_ocupadas();
