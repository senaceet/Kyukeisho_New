...
public class catalogo_juegos_nuevos_PC_DAO implements catalogo_juegos {
    ...
    public List listar() {
        ...
        String sql="select codigo_juego, nombre_juego,FORMAT(precio_juego,-3),cantidad_juegos,dir_img_juego,nombre_categoria_juegos,nombre_consola"
                    ...
                    +" join consola"
                    +" on consola.id_consola = juegos.id_consola  where cantidad_juegos>0 and juegos.id_consola=05 order by codigo_juego desc limit 4";
        try {
