                ...
                <div class="container" >
                    <div class="table-wrapper" bgcolor="#088A68">
                        <div class="table-title" style="background-color: rgb(216, 211, 40)">
                            ...
                            <div class="row" >
                                ...
                                <div class="col-lg-6" >
                                    ...
                                    <form name="form1" action="ReporteCategoriaJuegos.jsp" target="_black">
                                ...
                                <div class="container" style="background-color:#FFFFFF">
                                    <table class="table table-striped table-hover "  width="1000">
                                        ...
                                        <tr>
                                            ...
                                            <td><%= ma.getid_categoria_juegos()%></td>
                                            <td><%= ma.getnombre_categoria_juegos()%></td>
                                            <td>
                                                <a href="controlador_Categorias_juegos?accion=editar&id_categoria_juegos=<%= ma.getid_categoria_juegos()%>" class="edit"><i
                                                        style="color:rgb(245, 221, 9)" class="material-icons" data-toggle="tooltip" title="Editar" value="">&#xE254;</i></a>

                                                <a href="controlador_Categorias_juegos?accion=elimi&id_categoria_juegos=<%= ma.getid_categoria_juegos()%>" class="delete"><i
                        ...
                        <div id="addcate" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="controlador_Categorias_juegos">
                                    ...
                                    <form action="controlador_Categorias_juegos">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" required value="<%= ma2.getnombre_categoria_juegos()%>" name="nomC2">
                                                <input type="hidden" class="form-control" required value="<%= ma2.getid_categoria_juegos()%>" name="id_categoria_juegos2">
                                            </div>
                                        </div>
                                        <div class="modal-footer" style="background-color: rgb(216, 211, 40)">
                                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="controlador_Categorias_juegos">
                                        ...
                                        <input type="hidden" class="form-control" required value="<%= ma3.getid_categoria_juegos()%>" name="id_categoria_juegos3">
