...
<html lang="en">
    <head>
        <title>HomePage Kyukeisho</title>
              ...
              <div class="container">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 white-text text-center text-md-left mt-xl-5 mb-5 wow fadeInLeft" data-wow-delay="0.3s">
                    <h1 class="h1-responsive font-weight-bold mt-sm-5">Kyukeisho es una empresa desarrolladora de software </h1>
                    <hr class="hr-light">
                    <h6 class="mb-4">Kyukeisho oficial, empresa desarrolladora de software de alta cálidad, con el fin de dar a conocer las nuevas tecnologias creando las mejores soluciones para nuestras empresas contratantes</h6>
                  </div>
                  <!--Grid column-->
                  <!--Grid column-->
