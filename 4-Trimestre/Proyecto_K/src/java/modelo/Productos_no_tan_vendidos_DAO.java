...
public class Productos_no_tan_vendidos_DAO implements CRUD_productos_vendidos {
    ...
    public List listar() {
        ...
        String sql="select id_producto,nombre_producto,cantidad_producto,precio_unitario_producto,tipo_producto.nombre_tipo_producto"
                    ...
                    +" on productos.id_tipo_producto = tipo_producto.id_tipo_producto where cantidad_producto >=25 ORDER BY id_producto asc limit 30";
        try {
