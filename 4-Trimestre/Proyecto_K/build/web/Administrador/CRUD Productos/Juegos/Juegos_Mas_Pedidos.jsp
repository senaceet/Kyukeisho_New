            ...
            <nav class="navbar navbar-default navbar-expand-xl navbar-dark bg-dark">
                ...
                <div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
                  <ul class="nav navbar-nav">
                        <li class="nav-item active"><a href="../../Administrador_inicio.html" class="nav-link">P谩gina de administraci贸n</a></li>
                  ...
                  <ul class="nav navbar-nav navbar-right ml-auto">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu" style="background-color: #343a40">
                        ...
                        <li><a href="../../../index.html" style="color: #ffffff" class="dropdown-item"><i class="material-icons"></i> Cerrar Sesi贸n</a></li>
                    </ul>
                    </li>
                  </ul>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href=" " class="btn btn-success" data-toggle="modal"><i
                                ...
                                </i><span>A馻dir Nuevo Juego</span></a>
                ...
                <div class="modal-content">
                    <form>
                        <div class="modal-header">
                            <h4 class="modal-title">A帽adir Juego</h4>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>C贸digo Juego</label>
                                <input type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar">
                            <input type="submit" class="btn btn-success" value="A帽adir">
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form>
                        ...
                        <div class="modal-body">
                            <p>驴Seguro Que Desea Eliminar Este Juego</p>
