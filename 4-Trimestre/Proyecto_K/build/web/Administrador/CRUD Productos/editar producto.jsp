    ...
    body
{
    ...
    <body>
        ...
        %>
        <form action="">
            <table border="1" width="292" align="center">
                <tr>
                    <td >id: </td>
                    <td ><input  style="color: rgb(255, 255, 255); background-color:rgb(0, 0, 0, 0)" type="text" name="txtid" value="<%=rs.getString(1)%>" readonly="readonly"></td>
                </tr>
                <tr>
                    <td>Nombre: </td>
                    <td><input style="color: rgb(255, 255, 255); background-color:rgb(0, 0, 0, 0)" type="text" value="<%=rs.getString(2)%>" name="txtnom"></td>
                </tr>
                <tr>
                    <td>cantidad: </td>
                    <td><input style="color: rgb(255, 255, 255); background-color:rgb(0, 0, 0, 0)" type="text" value="<%=rs.getString(3)%>" name="txtcantidad"></td>
                </tr>
                                <tr>
                    <td >precio unitario: </td>
                    <td><input style="color: rgb(255, 255, 255); background-color:rgb(0, 0, 0, 0)" type="text" value="<%=rs.getString(4)%>" name="txtprecio"></td>
                </tr>
                <tr>
                <br>
