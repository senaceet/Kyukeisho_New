...
CREATE TABLE `productos` (
  ...
  `precio_unitario_producto` int(10) DEFAULT NULL,
  `id_tipo_producto` int(10) NOT NULL,
  PRIMARY KEY (`id_producto`),
  KEY `fk_productos_tipo_producto_idx` (`id_tipo_producto`),
  CONSTRAINT `fk_productos_tipo_producto` FOREIGN KEY (`id_tipo_producto`) REFERENCES `tipo_producto` (`id_tipo_producto`) ON UPDATE CASCADE
