...
CREATE TABLE `usuario_servicios` (
  ...
  KEY `fk_usuario_servicios_id_usuario_idx` (`id_usuario`),
  KEY `fk_usuario_servicios_id_servicio_idx` (`id_servicio`),
  CONSTRAINT `fk_usuario_servicios_id_servicio` FOREIGN KEY (`id_servicio`) REFERENCES `servicios` (`id_servicio`) ON UPDATE CASCADE,
  CONSTRAINT `fk_usuario_servicios_id_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`) ON UPDATE CASCADE
